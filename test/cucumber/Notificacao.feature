...
#Controller
  Scenario: Update a report
   ...
   When I add the evaluation "MANA" in the criterion "blah blah" at turma "ESS" and periodo "2016.2" with origin "Mini-Test" and date "26/04/2016" to the student with name "Saulo Henrique Dias" and the login "shd2"

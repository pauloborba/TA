...
#Controller scenario
  Scenario: new class with duplicate ID and periodo
    ...
    When I add a class with ID "PLC" and period "2017.1"
    Then the class "PLC" with period "2017.1" is not stored twice in the system

#GUI scenario
  Scenario: new class
    Given I am at the Create Class page
    When I fill the class details with name "PLC", period "2016.2"
    And I save the class
    Then I can see a confirmation message
    And I can see the information for class "PLC", period "2016.2" at the Turmas page

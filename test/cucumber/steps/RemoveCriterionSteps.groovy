...
And(~'^this student has an evaluation in criterion "([^"]*)" at turma "([^"]*)" and periodo "([^"]*)"$') {
    String criterionDesc, String classID, String periodo ->
...
When(~'^I remove the criterion "([^"]*)" at turma "([^"]*)" and periodo "([^"]*)"$') {
...
Then(~'^I should not see the criterion "([^"]*)" at turma "([^"]*)" and periodo "([^"]*)" listed in the student with login "([^"]*)"$') {

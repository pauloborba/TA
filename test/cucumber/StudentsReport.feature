...
#GUI Scenario
  ...
  Scenario: Row view of the student that pass, pass on final and don't pass
    Given The system has the students "Joao", "Caio", "Henrique" of logins "jkd", "caf", "herk" respectively
    And The system has the criterions "Patterns", "Feature", "Scenario"
  ...
  Scenario: View of total criterions evaluated
    Given The system has the student "Ricardo" of login "rcc"
    And The system has the criterions "Patterns", "Feature", "Scenario" and "Refactoring"
  ...
  Scenario: View of students that passed, passed on finals, failed for non-attendance, failed by score and number of total students
    Given The system has the students "Joao", "Caio", "Henrique", "Juliano" of logins "jkd", "caf", "herk", "jqo", respectively
    And The system has the criterions "Patterns", "Scenario"

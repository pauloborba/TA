...
#Controller Scenario
  Scenario: Register a criterion that does not exist
    Given the criterion with name "P1" at turma "ESS" and periodo "2016.2" is not on the system
    When I create the criterion "P1" at turma "ESS" and periodo "2016.2"
    Then the criterion "P1" at turma "ESS" and periodo "2016.2" is properly added to the system

#Controller Scenario
  Scenario: Register a criterion that already exists
    Given the criterion named "P2" at turma "ESS" and periodo "2016.2" already exists on the system
    When I create the criterion with description "P2" at turma "ESS" and periodo "2016.2"
    Then the system does nothing

#GUI Scenario
  Scenario: Error when registering a criterion that already exists
    Given the criterion "P3" already exists at turma "ESS" and periodo "2016.2"
    And I am on the Add Criterion page
    When I add the criterion "P3" at turma "ESS" and periodo "2016.2"

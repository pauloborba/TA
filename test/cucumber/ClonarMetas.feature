Feature: Clonar Metas de Outras Turmas
  ...
  @ignore
  Scenario: clonar Metas diferentes de outra Turma
    Given Existe uma turma "if666" registrada com as metas "Entender Groovy, Entender Grails, Entender o que é MANA"
    When acao TurmaController:appendMetas recebe metas "Entender Java, Entender JQuery" para essa turma

...
class EvaluationDataAndOperations{
    ...
    public static boolean createCriterion(String criterionName, turma){
        CriterionTestDataAndOperations.createCriterion(criterionName, turma);
        return true
    }
    ...
    public static Student getStudent(String login){
        ...
        return student.getStudent(login)
    }

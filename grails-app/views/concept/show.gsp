	...
	<body>
		...
		<div id="show-concept" class="content scaffold-show" role="main">
			...
			<ol class="property-list concept">
				...
				<g:if test="${conceptInstance?.nome}">
				<li class="fieldcontain">
					<span id="nome-label" class="property-label"><g:message code="concept.nome.label" default="Nome" /></span>
					
						<span class="property-value" aria-labelledby="nome-label"><g:fieldValue bean="${conceptInstance}" field="nome"/></span>

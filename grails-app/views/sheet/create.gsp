...
<html>
	...
	<body>
		<a href="#create-concept" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-concept" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:conceptInstance, action:'save']" >
				<fieldset class="form">

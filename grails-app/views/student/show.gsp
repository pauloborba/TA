	...
	<body>
		...
		<div id="show-student" class="content scaffold-show" role="main">
			...
			<ol class="property-list student">
				...
				<g:if test="${studentInstance?.evaluationCriteria}">
				<li class="fieldcontain">
					<span id="evaluationCriteria-label" class="property-label"><g:message code="student.evaluationCriteria.label" default="Evaluation Criteria" /></span>
					
						<span class="property-value" aria-labelledby="evaluationCriteria-label"><g:fieldValue bean="${studentInstance}" field="evaluationCriteria"/></span>

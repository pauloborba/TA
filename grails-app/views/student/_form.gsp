...
<div class="fieldcontain ${hasErrors(bean: studentInstance, field: 'evaluationCriteria', 'error')} ">
	<label for="evaluationCriteria">
		<g:message code="student.evaluationCriteria.label" default="Evaluation Criteria" />

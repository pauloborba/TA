		...
		<div id="list-evaluationConcept" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nome" title="${message(code: 'evaluationConcept.nome.label', default: 'Nome')}" />
				...
				<g:each in="${evaluationConceptInstanceList}" status="i" var="evaluationConceptInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${evaluationConceptInstance.id}">${fieldValue(bean: evaluationConceptInstance, field: "nome")}</g:link></td>

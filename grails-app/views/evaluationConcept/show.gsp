...
<html>
	...
	<body>
		<a href="#show-evaluationConcept" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-evaluationConcept" class="content scaffold-show" role="main">
			...
			<ol class="property-list evaluationConcept">
				...
				<li class="fieldcontain">
					<span id="conceitos-label" class="property-label"><g:message code="evaluationConcept.conceitos.label" default="conceitos" /></span>
						...
						<span class="property-value" aria-labelledby="conceitos-label"><g:link controller="concept" action="show" class="concepts" id="${c.id}">${c?.nome}</g:link></span>
						</g:each>
			...
			<g:form url="[resource:evaluationConceptInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${evaluationConceptInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

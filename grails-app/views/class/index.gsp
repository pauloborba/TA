...
<div id="list-class" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="name" title="${message(code: 'class.classID.label', default: 'Name')}" />
        ...
        <g:each in="${classInstanceList}" status="i" var="classInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show" name="${classInstance.classID}" periodo="${classInstance.periodo}">${fieldValue(bean: classInstance, field: "name")}</g:link></td>
